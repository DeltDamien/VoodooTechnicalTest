...
{
    public class PersonalizeOffersSDK : MonoBehaviour
    {
        [SerializeField]
        ...
        private void Start()
        {
            ...
            _controllers = new Controllers(_services, _playerGuid, personalizedOffersParameters.SanityCheckPeriodInSecond);
        }
    }
}
